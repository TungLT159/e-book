  ...
  return (
    ...
    >
      ...
      <div className="interactive-reader__menu-sidebar">
        ...
        <div className="interactive-reader__menu-section">
          <button
            type="button"
            className="interactive-reader__menu-button"
            onClick={flipToPreviousPage}
            disabled={currentPageIndex <= 0}
            aria-label="Trang trước"
            title="Trang trước"
          >
            <ChevronLeft aria-hidden="true" />
            <span className="interactive-reader__tooltip">Trang trước</span>
          </button>
          <button
            type="button"
            className="interactive-reader__menu-button"
          ...
          >
            <ChevronRight aria-hidden="true" />
            <span className="interactive-reader__tooltip">Trang tiếp theo</span>
          </button>
        </div>
        ...
        <div className="interactive-reader__menu-section">
          ...
          >
            ...
            <span className="interactive-reader__tooltip">Phóng to</span>
          </button>
          <button
            type="button"
            className="interactive-reader__menu-button"
          ...
          >
            ...
            <span className="interactive-reader__tooltip">Thu nhỏ</span>
          </button>
          <button
            type="button"
            className="interactive-reader__menu-button"
          ...
          >
            ...
            <span className="interactive-reader__tooltip">
              {isFullscreen ? "Thoát toàn màn hình" : "Toàn màn hình"}
            </span>
          </button>
          <button
          ...
          >
            ...
            <span className="interactive-reader__tooltip">Hình thu nhỏ</span>
          </button>
        </div>

        {/* Section 3: Audio & Auto-flip */}
        <div className="interactive-reader__menu-section">
          <button
            type="button"
            className="interactive-reader__menu-button"
          ...
          {/* TTS Settings Button with Submenu */}
          <div style={{ position: "relative" }}>
            ...
            >
              ...
              <span className="interactive-reader__tooltip">Cài đặt TTS</span>
            </button>
          ...
          >
            ...
            <span className="interactive-reader__tooltip">
              {isAutoFlipEnabled ? "Dừng tự lật" : "Tự lật trang"}
            </span>
          </button>
          ...
          >
            ...
            <span className="interactive-reader__tooltip">Trang đầu</span>
          </button>
          ...
          >
            ...
            <span className="interactive-reader__tooltip">Trang cuối</span>
          </button>
        </div>
      </div>
