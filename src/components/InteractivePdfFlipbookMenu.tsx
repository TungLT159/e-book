  ...
  return (
    <>
      <header className="interactive-reader__header">
        ...
        <div className="interactive-reader__menu-anchor">
          <button
            type="button"
            ...
            >
              <div className="interactive-reader__menu-sections">
                <div className="menu-section menu-section--view">
                  <h3 className="menu-section__title">Màn hình</h3>
                  <button
                    type="button"
                ...
                <div className="menu-section menu-section--audio">
                  <h3 className="menu-section__title">Âm thanh & Công cụ</h3>
                  <button
                    type="button"
                      ...
                      >
                        ...
                        <label className="interactive-reader__tts-field">
                          ...
                          <input
                            ...
                            value={speechVolume}
                            onChange={(event) =>
                              setSpeechVolume(Number(event.target.value))
                            }
                            aria-label="Âm lượng"
                          />
                          <output aria-live="polite">
